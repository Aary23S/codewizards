    ...
    <div className="max-w-3xl mx-auto px-4 py-20">
      ...
      {!isOwnProfile && profile.isMentor && currentUser && (
        <div className="border border-gray-800 rounded-xl p-6 bg-gray-900">
          <h2 className="text-xs uppercase tracking-widest text-gray-500 mb-4">Mentorship</h2>
          <p className="text-gray-400 text-sm mb-4">
            {profile.name.split(" ")[0]} is open to mentoring. Send a request to connect.
          </p>
          <button className="bg-white text-black px-6 py-2 rounded-lg text-sm font-semibold hover:bg-gray-200 transition-colors">
            Request Mentorship
          </button>
        </div>
      )}
